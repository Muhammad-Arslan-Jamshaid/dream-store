  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          if (result.text === "OK") {
            alert("Thank you for your subscription! Have a nice day!");
          }
      ...
      <div className="mx-auto mt-6 py-20 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div className="relative overflow-hidden shadow-gray-500 bg-gradient to r #111827 , #102256 px-6 py-24 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
          ...
          <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
            Keep pace with DREAMSTORE™ web services advancements! Join our
            mailing list to get discount coupons and promotional updates.
          </p>
          <form
            ref={form}
            onSubmit={sendEmail}
